/* Copyrigjt (C) 2024 Alberto Pianon <pianon@array.eu>
...
fun PackageRule.howToFixLicenseViolationDefault(
    ...
    return "${customResolveViolationText(pkg.metadata, license)}".trimMargin()
}
...
fun customResolveViolationText(pkg: Package, license: String) : String {
    return "Check with your legal team to resolve this violation."
}
